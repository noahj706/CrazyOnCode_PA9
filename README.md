...
Walker Raubuch - Lab Section 11

\-Player object class (including controls and sprite management/animation)

\-Additional wall graphics

\-this readme.txt file



Angelo Reyes - Lab Section 06

\-UI and Scoreboard class (including UI and program visuals)

\-Stage creation and management (including backgrounds and graphics)

\-Sound effects, graphics, BGM



Lincoln Young - Lab Section 01

\-Wall object class (including loading maps from files)
