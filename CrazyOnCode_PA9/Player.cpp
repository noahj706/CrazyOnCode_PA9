...
Player::Player(const Vector2& position, const PlayerId& playerId, const float& angle, int cooldownLength, const float& speed, const float& radius)
...
PlayerId Player::getId(void) const { return playerId; }

// Enable/disable player movement
void Player::enablePlayerMovement(const bool& tf) { movementEnabled = tf; }
